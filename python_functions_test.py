...
#   @unittest.skip("delete this line to run the test")
  def test_reverse_string(self):
    #add test code here
    test_string = "bobs"
    reverse_string_result = reverse_string(test_string)
    self.assertEqual("sbob", reverse_string_result)
...
#   @unittest.skip("delete this line to run the test")
  def test_fahrenheit_to_celsius(self):
    #add test code here
    fahrenheit = 32
    fahrenheit_to_celsius_result = fahrenheit_to_celsius(fahrenheit)
    self.assertEqual( 0, fahrenheit_to_celsius_result)
